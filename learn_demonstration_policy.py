...
def create_model(n_features, n_labels, series_len, n_layers = 2, n_nodes = 256):
...
if __name__ == '__main__':
    ...
    data = np.hstack([data[:, action_dim : action_dim + action_dim], data[:, action_dim * 2 + 1 :]])
    ...
    model = create_model(n_features, action_dim, series_len)
    epochs = 10000
    batch_size = 64
